...
public class TournamentPlay extends AppCompatActivity implements OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        session = new UserSessionManager(TournamentPlay.this);
        ...
        textSize = Integer.parseInt(Session.getSavedTextSize(TournamentPlay.this));
        Session.removeSharedPreferencesData(TournamentPlay.this);
        RightSwipe_A = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.anim_right_a);
        RightSwipe_B = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.anim_right_b);
        RightSwipe_C = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.anim_right_c);
        RightSwipe_D = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.anim_right_d);
        RightSwipe_E = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.anim_right_e);
        Fade_in = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.fade_out);
        fifty_fifty_anim = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.fifty_fifty);
    ...
    public void resetAllValue() {
        ...
        animation = AnimationUtils.loadAnimation(TournamentPlay.this, R.anim.right_ans_anim); // Change alpha from fully visible
        ...
        if (Utils.isNetworkAvailable(TournamentPlay.this)) {
    ...
    public void levelCompleted() {
        ...
        Intent intent = new Intent(TournamentPlay.this, CompleteActivityTournaments.class);
    ...
    public void UpdateScore(final String score, final String queattend) {
        ...
        params.put(Constant.userId, Session.getUserData(Session.USER_ID, TournamentPlay.this));
    ...
    public void PlayAreaLeaveDialog() {
        ...
        if (!tvAlert.getText().equals(getResources().getString(R.string.no_enough_question))) {
            stopTimer();
            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(TournamentPlay.this);
    ...
    public void rightSound() {
        if (Session.getSoundEnableDisable(TournamentPlay.this))
            Utils.setrightAnssound(TournamentPlay.this);

        if (Session.getVibration(TournamentPlay.this))
            Utils.vibrate(TournamentPlay.this, Utils.VIBRATION_DURATION);
    ...
    private void playWrongSound() {
        if (Session.getSoundEnableDisable(TournamentPlay.this))
            Utils.setwronAnssound(TournamentPlay.this);
    ...
    public void FiftyFifty(View view) {
        Utils.btnClick(view, TournamentPlay.this);
        // CheckSound();
        if (!Session.isFiftyFiftyUsed(TournamentPlay.this)) {
            if (Constant.TOTAL_COINS >= 4) {
                ...
                Session.setFifty_Fifty(TournamentPlay.this);
            } else
                ShowRewarded(TournamentPlay.this);
    ...
    public void SkipQuestion(View view) {
        ...
        if (!Session.isSkipUsed(TournamentPlay.this)) {
            if (Constant.TOTAL_COINS >= 2) {
                ...
                questionIndex++;
                nextQuizQuestion();
                Session.setSkip(TournamentPlay.this);
            } else
                ShowRewarded(TournamentPlay.this);
        } else
            AlreadyUsed();
    ...
    public void AudiencePoll(View view) {
        Utils.btnClick(view, TournamentPlay.this);
        //CheckSound();
        if (!Session.isAudiencePollUsed(TournamentPlay.this)) {
            if (Constant.TOTAL_COINS >= 4) {
                btnPosition = 0;
                Constant.TOTAL_COINS = Constant.TOTAL_COINS - 4;
                if (Session.isLogin(getApplicationContext()))
                ...
                if (Session.getBoolean(Session.E_MODE, getApplicationContext()))
                    ...
                    AudienceWithout_E();
                Session.setAudiencePoll(TournamentPlay.this);
            } else
                ShowRewarded(TournamentPlay.this);
        } else
            AlreadyUsed();
    ...
    public void ResetTimer(View view) {
        Utils.btnClick(view, TournamentPlay.this);
        // CheckSound();
        if (!Session.isResetUsed(TournamentPlay.this)) {
            if (Constant.TOTAL_COINS >= 2) {
                Constant.TOTAL_COINS = Constant.TOTAL_COINS - 2;
                if (Session.isLogin(getApplicationContext()))
                    Utils.UpdateCoin(getApplicationContext(), "-" + 2);
                ...
                stopTimer();
                starTimer();
                Session.setReset(TournamentPlay.this);
            } else
                ShowRewarded(TournamentPlay.this);
        } else
            AlreadyUsed();
    ...
    public void AlreadyUsed() {
        stopTimer();
        final AlertDialog.Builder dialog = new AlertDialog.Builder(TournamentPlay.this);
    ...
    public void CheckSound() {
        ...
        if (Session.getSoundEnableDisable(TournamentPlay.this))
            Utils.backSoundonclick(TournamentPlay.this);
    ...
    public void SettingButtonMethod() {
        ...
        Intent intent = new Intent(TournamentPlay.this, SettingActivity.class);
        startActivity(intent);
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (Session.getBoolean(Session.E_MODE, TournamentPlay.this)) {
    ...
    public void showRewardedVideo() {
        ...
        if (rewardedVideoAd != null) {
            ...
            Activity activityContext = TournamentPlay.this;
    ...
    private void AddPoint(final String point, final String type, final Boolean isminus) {
        ...
        params.put(Constant.USER_ID, Session.getUserData(Session.USER_ID, TournamentPlay.this));
    ...
    public void onResume() {
        Utils.CheckBgMusic(TournamentPlay.this);
        if (Constant.LeftTime != 0) {
            timer = new Timer(leftTime, 1000);
            timer.start();
        }
    ...
    public void onDestroy() {
        ...
        if (Session.getSoundEnableDisable(TournamentPlay.this)) {
            ...
            MediaPlayer mediaplayer = MediaPlayer.create(TournamentPlay.this, resourceId);
            ...
            MediaPlayer mediaplayers = MediaPlayer.create(TournamentPlay.this, resourceIds);
