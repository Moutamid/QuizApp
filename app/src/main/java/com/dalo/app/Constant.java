...
public class Constant {
    ...
    private static String DOMAIN_URL = "https://www.dalo.games/daloadmin/"; //domain or admin panel url
    ...
    public static String getFaq = "get_faq";
    ...
    public static int MAX_MINUTES = 10; //max minutes for self challenge app
    public static int MAX_QUESTION_PER_BATTLE = 15; // max question per level
    public static int RANDOM_QUE_LIMIT = 15;
    public static int PRACTICE_QUE_LIMIT = 0;
    ...
    public static int CIRCULAR_MAX_PROGRESS = 10; // max here we set 25 second for each question, you can increase or decrease time here
    public static int TIME_PER_QUESTION = 15000;  //here we set 25 second to milliseconds
    ...
    public static int FOR_CORRECT_ANS = 10; // mark for correct answer
    public static int PENALTY = 4;// minus mark for incorrect
