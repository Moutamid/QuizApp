...
import com.dalo.app.activity.LeaderboardAdapter;
...
import com.dalo.app.model.LeaderBoard;
...
import static com.dalo.app.Constant.PAGE_LIMIT;
            ...
            ApiConfig.RequestToVolley(new ApiConfig.VolleyCallback() {
                ...
                public void onSuccess(boolean result, String response) {
                    ...
                    if (result) {
                        try {
                            if (getActivity() != null) {
                                //System.out.println("DailyResponse::=" + response);
