...
import com.dalo.app.activity.MainActivity;
import com.dalo.app.activity.PrivacyPolicy;

import com.dalo.app.helper.ApiConfig;
import com.dalo.app.helper.Session;
import com.dalo.app.helper.Utils;
import com.dalo.app.model.User;
...
/*        if (Constant.VERSION_STATUS.equals("0")) {
                        ...
                        if (obj.getString("error").equals("false")) {
                            ...
                            if (!jsonobj.getString(Constant.status).equals(Constant.DE_ACTIVE)) {
                                Session.saveUserDetail(getActivity(),
                                        ...
                                        jsonobj.getString(Constant.PROFILE), referCode, type);
    ...
    public void MobileBottomshit(final FirebaseAuth firebaseAuth) {
        ...
        countryCodePicker.setCountryForNameCode("NP");
